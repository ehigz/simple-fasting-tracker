...
export function TermsScreen({ onBack }: Props) {
  return (
    <View className="flex-1">
      {/* Back header */}
      <Pressable onPress={onBack} className="flex-row items-center gap-[6px] px-1 pb-4">
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="pb-12 gap-3">
        ...
        <Text className="text-muted-fg text-[13px] mb-2">Contact: hello@simplefasting.io</Text>
        <Text className="text-muted-fg text-sm leading-[22px]">
        ...
        <Text className="text-primary text-sm font-semibold mb-[6px]">This app does not provide medical advice.</Text>
        <Text className="text-muted-fg text-sm leading-[22px]">
